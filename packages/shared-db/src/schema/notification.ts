// shared/db/schema/notification.ts
import { pgTable, uuid, varchar, text, boolean, timestamp, pgEnum } from 'drizzle-orm/pg-core'
import { users } from './auth'

export const notifTypeEnum = pgEnum('notif_type', [
  'sale', 'price_alert', 'ai_narrative', 'show_reminder',
  'aging_alert', 'offer_received', 'inventory_trending',
  'want_list_match', 'platform_alert', 'weekly_digest',
  'new_dealer_inventory', 'system'
])
...
export const notifications = pgTable('notifications', {
  ...
  data:         text('data'),                                     // JSON: deep link params
