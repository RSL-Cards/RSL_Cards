...
const envSchema = z.object({
  ...
  RESEND_DOMAIN: z.string().optional().default("rslcardspro.com"),
  RESEND_FROM_EMAIL: z.string().email().optional().default("noreply@rslcardspro.com"),
  RESEND_FROM_NAME: z.string().optional().default("RSL Cards"),
