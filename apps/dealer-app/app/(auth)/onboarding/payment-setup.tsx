...
const PAYMENT_PLATFORMS = [
  { key: 'venmo',   label: 'Venmo',   icon: 'V', iconBg: '#5C27D9', placeholder: '@handle' },
  { key: 'cashapp', label: 'CashApp', icon: '$', iconBg: '#00C853', placeholder: '$cashtag' },
  { key: 'zelle',   label: 'Zelle',   icon: 'Z', iconBg: '#6E00FF', placeholder: 'Phone or email' },
  { key: 'paypal',  label: 'PayPal',  icon: 'P', iconBg: '#003087', placeholder: 'Email' },
]
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView contentContainerStyle={{ flexGrow: 1 }} keyboardShouldPersistTaps="handled">
        <View style={styles.content}>
          ...
          <Text style={styles.subtitle}>Generate QR codes instantly during sales</Text>
              ...
              <View key={p.key} style={styles.paymentCard}>
                ...
                <View style={{ flex: 1 }}>
                  ...
                  <TextInput
                    ...
                    value={handles[p.key] || ''}
                    onChangeText={v => setHandles(prev => ({ ...prev, [p.key]: v }))}
                    autoCapitalize="none"
                  />
                </View>
              </View>
      ...
      <View style={styles.bottomSection}>
        <TouchableOpacity onPress={() => router.push('/(auth)/onboarding/tutorial')} style={{ alignItems: 'center', marginBottom: 12 }}>
          <Text style={styles.skipText}>Skip for now</Text>
        </TouchableOpacity>
        <TouchableOpacity
          style={styles.continueBtn}
          onPress={() => router.push('/(auth)/onboarding/tutorial')}
          activeOpacity={0.85}
        >
...
const styles = StyleSheet.create({
  ...
  platformLabel: { color: 'white', fontWeight: '600', fontSize: 14, marginBottom: 6 },
  platformInput: {
