        ...
        <ScrollView contentContainerStyle={{ flexGrow: 1 }} keyboardShouldPersistTaps="handled">
          ...
          <View style={styles.content}>
            ...
            <View style={styles.form}>
              ...
              <TextInput style={styles.input} value={name} onChangeText={setName} placeholder="Mike Sherrer" placeholderTextColor="#555555" />

              <View style={{ height: 20 }} />
              <Text style={styles.label}>EMAIL ADDRESS</Text>
              <TextInput style={styles.input} value={email} onChangeText={setEmail} placeholder="you@example.com" placeholderTextColor="#555555" keyboardType="email-address" autoCapitalize="none" />

              <View style={{ height: 20 }} />
              <Text style={styles.label}>PASSWORD</Text>
              <TextInput style={styles.input} value={password} onChangeText={setPassword} placeholder="••••••••" placeholderTextColor="#555555" secureTextEntry />

              <View style={{ height: 20 }} />
              <Text style={styles.label}>CONFIRM PASSWORD</Text>
              <TextInput style={styles.input} value={confirm} onChangeText={setConfirm} placeholder="••••••••" placeholderTextColor="#555555" secureTextEntry />
              ...
              <View style={{ flexDirection: 'row', gap: 10, marginTop: 8 }}>
                ...
                >
                  <Text style={[styles.roleChipText, isDealer && styles.roleChipTextActive]}>I'm a Dealer</Text>
                </TouchableOpacity>
                <TouchableOpacity
                  style={[styles.roleChip, !isDealer && styles.roleChipActive]}
                  onPress={() => setIsDealer(false)}
                >
                  <Text style={[styles.roleChipText, !isDealer && styles.roleChipTextActive]}>I'm a Collector</Text>
                </TouchableOpacity>
              </View>
...
const styles = StyleSheet.create({
  ...
  form: { marginTop: 40 },
  label: { fontSize: 12, color: '#888888', fontWeight: '600', letterSpacing: 1, marginBottom: 8 },
  input: {
