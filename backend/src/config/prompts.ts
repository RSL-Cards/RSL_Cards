...
- "variation": the parallel/refractor name exactly as it appears on the card or is commonly known on eBay (e.g. "Silver Prizm", "Gold Refractor", "Holo", "Base", "Blue Wave", "Red /299"). **CRITICAL: Carefully look at the color and foil of the card in the image to deduce if it is a Silver, Red, Blue, etc., parallel. WARNING: Do not confuse the color of the grading slab (e.g., black Beckett Pristine slabs) with the card's parallel color.** Include the print run if visible (e.g. "Orange /49"). If base/no variation, use "Base"
